...
```
npm install --save cd2-camera-integrator
```
...
import {Camera} from "cd2-camera-integrator";
...
[See demo](https://purple-technology.github.io/cd2-camera-integrator/)

[See example code](https://github.com/purple-technology/cd2-camera-integrator/blob/8290b1319d7436c77403784fe845060f6c4ed3bd/example/src/App.tsx#L120)
...
[downloads-badge]: https://img.shields.io/npm/dw/cd2-camera-integrator.svg?style=flat-square
[npm-badge]: https://img.shields.io/npm/v/cd2-camera-integrator

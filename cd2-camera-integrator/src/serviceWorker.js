    ...
    window.addEventListener('load', () => {
      ...
      if (isLocalhost) {
        ...
        navigator.serviceWorker.ready.then(() => {
          console.log(
            'Este aplicativo da web está sendo servido primeiro em cache por um serviço ' +
            'trabalhador. Para saber mais, acesse https://bit.ly/CRA-PWA',
          );
        });
      } else {
        ...
        installingWorker.onstatechange = () => {
          if (installingWorker.state === 'installed') {
            if (navigator.serviceWorker.controller) {
              ...
              console.log(
                'Novo conteúdo está disponível e será usado quando todos os ' +
                'as abas desta página estão fechadas. Consulte https://bit.ly/CRA-PWA.',
              );
